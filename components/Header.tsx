...
export const Header: React.FC<HeaderProps> = ({ onLogoClick, onJoin }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 bg-white/90 dark:bg-midnight/90 backdrop-blur-md border-b border-gray-100 dark:border-white/10">
