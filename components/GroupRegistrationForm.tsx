    ...
    return (
      <div className="min-h-screen bg-midnight flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-2xl animate-fade-in">
          ...
          <h2 className="text-2xl font-display font-bold text-midnight mb-2">Thank You!</h2>
  ...
  return (
    <div className="min-h-screen bg-midnight flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl animate-slide-up">
        <button 
          onClick={onBack}
          className="flex items-center text-gray-500 hover:text-midnight mb-6 transition-colors"
        >
          <span className="material-icons-round text-lg mr-1">arrow_back</span>
          Back
        </button>
        
        <h2 className="text-2xl font-display font-bold text-midnight mb-2">Register Your Group</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-1">Group / Contact Name</label>
            <input
              type="text"
              required
          ...
          <button
            type="submit"
            className="w-full py-4 mt-4 bg-primary hover:bg-primary-hover text-white font-bold rounded-lg transition-colors shadow-lg shadow-primary/30"
          >
            Submit Registration
          </button>
        </form>
